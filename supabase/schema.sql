...
-- ============================================================
-- TABELA: withdrawals
-- Registra cada "zeramento" de saldo, quando o admin repassa o
-- dinheiro manualmente (PIX, dinheiro etc.) pro entregador e marca
-- como pago. Serve de histórico - não mexe no delivery_history,
-- só marca até onde já foi pago.
-- ============================================================
...
-- ---------- withdrawals ----------
-- admin: acesso total (registra o pagamento manual feito por fora)
create policy "admin acesso total a withdrawals"
  on public.withdrawals for all
  using (public.is_admin())
  with check (public.is_admin());

-- driver: só consulta o próprio histórico de saques (não pode criar/editar)
...
-- ============================================================
-- ============================================================
-- TABELA: expenses (sistema de controle financeiro)
-- ============================================================
...
-- ============================================================
-- TABELA: payments (registro de pagamentos de faturas e dívidas)
-- ============================================================
...
-- ── RLS e GRANTs das novas tabelas ──────────────────────────────────────
